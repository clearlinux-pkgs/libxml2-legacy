...
%package license
Summary: license components for the libxml2-legacy package.
Group: Default

%description license
license components for the libxml2-legacy package.


%package man
Summary: man components for the libxml2-legacy package.
Group: Default

%description man
man components for the libxml2-legacy package.
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/libxml2-legacy/Copyright
